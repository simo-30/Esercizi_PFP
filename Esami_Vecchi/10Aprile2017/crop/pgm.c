...
//  Author:         (c) 2013-2017 Camil Demetrescu
...
// pgm_load
// ---------------------------------------------------------------------
int pgm_load(unsigned char** img, unsigned* rows, unsigned* cols, const char* filename) {
...
// pgm_save
// ---------------------------------------------------------------------
int pgm_save(unsigned char* img, unsigned rows, unsigned cols, const char* filename) {
...
// Copyright (C) 2013-2017 Camil Demetrescu
